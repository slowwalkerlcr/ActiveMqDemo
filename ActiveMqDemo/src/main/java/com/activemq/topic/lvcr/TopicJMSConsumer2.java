...
public class TopicJMSConsumer2 {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(TopicJMSConsumer2.USERNAME, TopicJMSConsumer2.PASSWORD, TopicJMSConsumer2.BROKEURL);
        ...
        try {
            ...
            messageConsumer.setMessageListener(new TopicMyJmsListener("TopicJMSConsumer2"));
