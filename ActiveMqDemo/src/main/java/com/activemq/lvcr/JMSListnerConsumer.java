 ...
 */
public class JMSListnerConsumer {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(JMSListnerConsumer.USERNAME, JMSListnerConsumer.PASSWORD, JMSListnerConsumer.BROKEURL);
        ...
        try {
            ...
            //6、设置消息监听
            messageConsumer.setMessageListener(new MyJmsListener());
