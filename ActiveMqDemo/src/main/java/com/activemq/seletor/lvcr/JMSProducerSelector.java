 ...
 */
public class JMSProducerSelector {
    //默认连接用户名
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(JMSProducerSelector.USERNAME, JMSProducerSelector.PASSWORD, JMSProducerSelector.BROKEURL);
        ...
        try {
            ...
            messageProducer.send(destination,mapMessage);
            messageProducer.send(destination,mapMessage2);
            messageProducer.send(destination,mapMessage3);
