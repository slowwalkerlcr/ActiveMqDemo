 ...
 */
public class DelayJMSListnerConsumer {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(DelayJMSListnerConsumer.USERNAME, DelayJMSListnerConsumer.PASSWORD, DelayJMSListnerConsumer.BROKEURL);
        ...
        try {
            ...
            //6、设置消息监听
            messageConsumer.setMessageListener(new MyDelayJmsListener());
