...
public class DelayJMSProducer {
    ...
    public static void main(String[] args) {
        ...
        connectionFactory = new ActiveMQConnectionFactory(DelayJMSProducer.USERNAME, DelayJMSProducer.PASSWORD, DelayJMSProducer.BROKEURL);
        ...
        try {
            ...
            destination = session.createQueue("DelayMessageQueue");
            ...
            //设置消息内容
            message.setText("Hello DelayActivemq");
    ...
    public static void sendMessage(Session session,MessageProducer messageProducer) throws Exception{
        for (int i = 0; i < DelayJMSProducer.SENDNUM; i++) {
            //创建一条文本消息
